...
public interface SQLRepository<T> extends Repository<T> {
	...
	List<T> findListByQuery(final String query, @SuppressWarnings("unchecked") final Entry<String, Object>... parameters);

	List<T> findListByQuery(final String query, final Integer firstResult, final Integer maxResults,
