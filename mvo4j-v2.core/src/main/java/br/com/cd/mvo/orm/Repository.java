...
public interface Repository<T> extends BeanObject {
	...
	T find(final Entry<String, Object> parameter,
	...
	List<T> findList(final Map<String, Object> map, final Integer firstResult,
			Integer maxResults);

	List<T> findList(final Map<String, Object> map, final Integer firstResult,
			Integer maxResults, final OrderBy orderBy);

	List<T> findList(final Map<String, Object> map,
			final LikeCritirionEnum likeCritiria);

	List<T> findList(final Map<String, Object> map,
			final LikeCritirionEnum likeCritiria, OrderBy orderBy);

	List<T> findList(final Map<String, Object> map,
			final LikeCritirionEnum likeCritiria, Integer firstResult,
	...
	List<T> findList(final Entry<String, Object> parameter,
			@SuppressWarnings("unchecked") Entry<String, Object>... parameters);

	List<T> findList(final OrderBy orderBy,
			final Entry<String, Object> parameter,
			@SuppressWarnings("unchecked") Entry<String, Object>... parameters);
